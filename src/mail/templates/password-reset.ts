      ...
      <tr><td align="center">
        <table width="480" cellpadding="0" cellspacing="0" style="background:#111827;border:1px solid #1f2937;border-radius:12px;overflow:hidden;">
          <tr><td style="padding:24px 32px;border-bottom:1px solid #1f2937;">
            ...
            <p style="margin:4px 0 0;font-size:11px;text-transform:uppercase;letter-spacing:0.18em;color:#64748b;">Redefinição de Senha</p>
          </td></tr>
          <tr><td style="padding:32px;">
            <h1 style="margin:0 0 12px;font-size:22px;color:#f8fafc;">Protocolo de Recuperação</h1>
            <p style="margin:0 0 20px;font-size:14px;line-height:1.6;color:#cbd5e1;">
              Olá, <strong style="color:#f8fafc;">${escapeHtml(name)}</strong>. Recebemos uma solicitação para redefinir
              a senha da sua conta. Use o código abaixo para concluir a alteração.
            </p>
            <div style="text-align:center;padding:24px;background:#0b1220;border:1px solid #1f2937;border-radius:8px;">
              <p style="margin:0 0 8px;font-size:11px;text-transform:uppercase;letter-spacing:0.18em;color:#64748b;">Código de Redefinição</p>
            ...
            <p style="margin:20px 0 0;font-size:12px;color:#64748b;">O código expira em 15 minutos. Se você não solicitou esta redefinição, ignore este e-mail — sua senha permanece inalterada.</p>
          </td></tr>
...
export function passwordResetSubject(): string {
  return 'InvestWealth — Código de Redefinição de Senha';
}
